...
module "rds" {
  source            = "github.com/gaddamrk/tf-module-rds"
  env               =  var.env
...
module "elasticache" {
  source            = "github.com/gaddamrk/tf-module-elasticache"
  env               =  var.env
...
module "rabbitmq" {
  source            = "github.com/gaddamrk/tf-module-rabbitmq"
  env               =  var.env
...
module "alb" {
  source            = "github.com/gaddamrk/tf-module-alb"
  env               =  var.env
...
module "apps" {
  source            = "github.com/gaddamrk/tf-module-apps"
  env               =  var.env
